...
## 3. Project Requests & Quotes
Submitting a request is an enquiry, not a contract. Prices shown for services are indicative starting points; final scope, price and timeline are agreed separately in writing before any engagement begins.
...
## 7. Termination
Access may be suspended for accounts that violate these terms.
